...
checkpointer = callbacks.ModelCheckpoint(filepath="logs/dls/cnnlstm/checkpoint-{epoch:02d}.hdf5", save_best_only=True, monitor='loss')
csv_logger = CSVLogger('logs/dls/cnnlstm/training_set_lstmanalysis.csv',separator=',', append=False)
...
model.save("logs/dls/cnnlstm/coomplemodel.hdf5")
